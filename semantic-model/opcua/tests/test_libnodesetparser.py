...
class TestNodesetParser(unittest.TestCase):
    ...
    def test_get_user_access_all_values(self, mock_get_contentclass):
        ...
        def side_effect(namespace, value, ig, base):
            if namespace == self.parser.rdf_ns['opcua']['AccessLevelType'] and value == 1:
                return content_access
            elif namespace == self.parser.rdf_ns['opcua']['AccessLevelType'] and value == 2:
                return content_user_access
            elif namespace == self.parser.rdf_ns['opcua']['AccessLevelExType'] and value == 3:
