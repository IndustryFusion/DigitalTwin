...
# if ${EID} is 'true' then set the variable $(EID) to '-eid'
ifeq ($(EID), true)
	EID := -eid
else
	EID :=
...
CORE_SHACL_NS         = http://example.com/v0.1/UA/
...
DI_SHACL_NS      = http://example.com/v0.1/DI/
...
IA_SHACL_NS           = http://example.com/v0.1/IA/
...
MACHINERY_SHACL_NS    = http://example.com/v0.1/Machinery/
...
PUMPS_SHACL_NS        = http://example.com/v0.1/Pumps/
...
MACHINETOOL_SHACL_NS      = http://example.com/v0.1/MachineTool/
...
LASERSYSTEMS_SHACL_NS      = http://example.com/v0.1/LaserSystems/
...
DICTIONARY_IRDI_SHACL_NS      = http://example.com/v0.1/Dictionary/IRDI/
...
PADIM_SHACL_NS      = http://example.com/v0.1/PADIM/
...
MACHINERY_PROCESSVALUES_SHACL_NS      = http://example.com/v0.1/Machinery/ProcessValues/
...
MACHINERY_JOBS_SHACL_NS      = http://example.com/v0.1/Machinery/Jobs/
...
MACHINERY_RESULT_SHACL_NS      = http://example.com/v0.1/Machinery/Result/
...
PACKML_SHACL_NS      = http://example.com/v0.1/PackML/
...
TMC_OPTS          = -p tmc
TMC_SHACL_NS      = http://example.com/v0.1/TMC/


# -----------------------------------------------------------------------------
# List of all target files to be built.
# -----------------------------------------------------------------------------
TARGET_NAMES = CORE DI IA MACHINERY MACHINETOOL LASERSYSTEMS LASERSYSTEMSEXAMPLE MACHINETOOLEXAMPLE MACHINERYEXAMPLE DICTIONARY_IRDI PADIM MACHINERY_PROCESSVALUES MACHINERY_JOBS PACKML MACHINERY_RESULT ISA95_JOBCONTROL PUMPS TMC PUMPEXAMPLE 

ALL_TARGETS = $(foreach t, $(TARGET_NAMES), $($(t)_ONTOLOGY:.owl.ttl=.shacl.ttl))
...
# -----------------------------------------------------------------------------
# Generic rule to build a .shacl.ttl file from a *.owl.ttl (nodeset2owl.py
# Semantic Bridge output).
#
...
%.owl.ttl:
	@echo "Creating missing base ontologies"
