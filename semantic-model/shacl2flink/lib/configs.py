...
kafka_topic_constraint_combination_table_name = "{{.Values.kafkaBridge.flink.constraintCombinationTopic.topicName}}" if \
                          helm else "iff.ngsild.flink.constraint_combination_table"
kafka_topic_constraint_combination_table_object = "{{.Values.kafkaBridge.flink.constraintCombinationTopic.objectName}}" if \
